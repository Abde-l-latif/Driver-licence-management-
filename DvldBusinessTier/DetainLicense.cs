...
namespace DvldBusinessTier
{
    public class DetainLicense
    {
        ...
        public Users CreatedByUserInfo { set; get; }
        public bool IsReleased { set; get; }
        public DateTime ReleaseDate { set; get; }
        public int ReleasedByUserID { set; get; }
        public Users ReleasedByUserInfo { set; get; }
...

        {
            ...
            this.CreatedByUserInfo = Users.getUserByUserID(this.CreatedByUserID);
            this.IsReleased = IsReleased;
            this.ReleaseDate = ReleaseDate;
            this.ReleasedByUserID = ReleasedByUserID;
            this.ReleaseApplicationID = ReleaseApplicationID;
            this.ReleasedByUserInfo = Users.getUserByUserID(this.ReleasedByUserID);
            Mode = enMode.Update;
        }

        public static DetainLicense FindByLicenseID(int LicenseID)
        {
        ...
        public static DetainLicense Find(int DetainID)
        {
            ...
            if (dataDetainLicense.GetDetainedLicenseInfoByID(DetainID,
        ...
        private bool _AddNewDetainedLicense()
        {
            ...
            this.DetainID = dataDetainLicense.AddNewDetainedLicense(
        ...
        private bool _UpdateDetainedLicense()
        {
            ...
            return dataDetainLicense.UpdateDetainedLicense(
        ...
        {
            return dataDetainLicense.isLicenseDetained(LicenseID);
        }

        public static DataTable GetAllDetainedLicenses()
        {
            return dataDetainLicense.getListDetainedLicenses();

        }

        public bool ReleaseDetainedLicense(int ReleasedByUserID, int ReleaseApplicationID)
        {
            return dataDetainLicense.ReleaseDetainedLicense(this.DetainID,
                   ReleasedByUserID, ReleaseApplicationID);
        }
