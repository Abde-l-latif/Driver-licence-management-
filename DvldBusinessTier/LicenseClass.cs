...
namespace DvldBusinessTier
{
    public class LicenseClass
    {
        ...
        {
            this.LicenseClassID = dataLicenseClass.AddNewLicenseClass(this.ClassName, this.ClassDescription,
        ...
        private bool _UpdateLicenseClass()
        {
            ...
            return dataLicenseClass.UpdateLicenseClass(this.LicenseClassID, this.ClassName, this.ClassDescription,
                this.MinimumAllowedAge, this.DefaultValidityLength, this.ClassFees);
        }
        ...
        public static LicenseClass Find(int LicenseClassID)
        {
            ...
            if (dataLicenseClass.GetLicenseClassInfoByID(LicenseClassID, ref ClassName, ref ClassDescription,
        ...
        public static LicenseClass Find(string ClassName)
        {
            ...
            if (dataLicenseClass.GetLicenseClassInfoByClassName(ClassName, ref LicenseClassID, ref ClassDescription,
                    ref MinimumAllowedAge, ref DefaultValidityLength, ref ClassFees))
        ...
        {
            return dataLicenseClass.GetAllLicenseClasses();
